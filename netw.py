...
def run_mnist_neural_network_app():
    ...
    def display_tab_content(tab_name):
        ...
        elif tab_name == "Chọn số lượng dữ liệu":
            with tabs[1]:
        ...
        elif tab_name == "Huấn luyện/Đánh giá":
            with tabs[4]:
                        ...
                        if st.button("Bắt đầu Huấn luyện", type="primary", key="start_training"):
                            try:
                                with st.spinner("Đang huấn luyện mô hình..."):
                                    ...
                                    st.session_state['active_tab'] = "Demo dự đoán"
        ...
        elif tab_name == "Thông tin huấn luyện":
            with tabs[6]:
